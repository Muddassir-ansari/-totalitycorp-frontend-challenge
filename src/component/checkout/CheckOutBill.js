...
export const CheckOutBill = () => {
  ...
  useEffect(() => {
    ...
    if (JSON.parse(sessionStorage.getItem("CheckoutDetails") !== null)) {
      setBillingDetails(JSON.parse(sessionStorage.getItem("CheckoutDetails")));
    }
  }, []);
              ...
              <div className="col-xl-8">
                <ul className="list-unstyled">
                  <li className="text-muted">
                    ...
                    <span
                      style={{ color: "#5d9fc5" }}
                    >{`${billingDetails.firstName} ${billingDetails.lastName}`}</span>
                  </li>
                  <li className="text-muted">{billingDetails.address}</li>
                  <li className="text-muted">{billingDetails.address2}</li>
                  <li className="text-muted">
